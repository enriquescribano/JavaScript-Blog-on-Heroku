    ...
    models.User
        ...
        .success(function(users) {
            res.render('users/index', {
                users: users, visitantes: res.locals.visitas
            });
        })
        .error(function(error) {
            next(error);
...
exports.show = function(req, res, next) {
    ...
    res.render('users/show', {
        user: req.user, visitantes: res.locals.visitas
    });
};
...
exports.new = function(req, res, next) {
    ...
    res.render('users/new', {user: user, visitantes: res.locals.visitas});
};
...
exports.edit = function(req, res, next) {
    ...
    res.render('users/edit', {user: req.user, visitantes: res.locals.visitas});
};
